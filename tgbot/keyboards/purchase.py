...
def get_bulk_purchase_keyboard(tariff_id: str) -> InlineKeyboardMarkup:
    ...
    kb.button(text="۱ عدد", callback_data=f"purchase_{tariff_id}_1")
    kb.button(text="۳ عدد", callback_data=f"purchase_{tariff_id}_3")
    kb.button(text="۵ عدد", callback_data=f"purchase_{tariff_id}_5")
    kb.button(text="۱۰ عدد", callback_data=f"purchase_{tariff_id}_10")
